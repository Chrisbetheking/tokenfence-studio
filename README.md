...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.3.1/TokenFence-Studio-Windows-v1.3.1-portable.zip)
...
Download `TokenFence-Studio-Windows-v1.3.1-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
