...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.5.0/TokenFence-Studio-Windows-v1.5.0-portable.zip)
...
Download `TokenFence-Studio-Windows-v1.5.0-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
