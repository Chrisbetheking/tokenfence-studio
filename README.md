...
**Languages:** [English](README.md) | [缁犫偓娴ｆ挷鑵戦弬鍢?README.zh-CN.md)
...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.2.5/TokenFence-Studio-Windows-v1.2.5-portable.zip)
...
Download `TokenFence-Studio-Windows-v1.2.5-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
