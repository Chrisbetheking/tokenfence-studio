...
- [Windows Portable ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.3.5/TokenFence-Studio-Windows-v1.3.5-portable.zip)
...
Download `TokenFence-Studio-Windows-v1.3.5-portable.zip`, extract it first, then run `tokenfence-studio.exe` from the extracted folder.
