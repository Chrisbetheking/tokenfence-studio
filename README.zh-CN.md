...
- [Windows 便携版 ZIP](https://github.com/Chrisbetheking/tokenfence-studio/releases/download/v1.0.5/TokenFence-Studio-Windows-v1.0.5-portable.zip)
...
下载 `TokenFence-Studio-Windows-v1.0.5-portable.zip`，先完整解压，再运行解压文件夹里的 `tokenfence-studio.exe`。
