...
| 平台 | 文件 | 类型 |
|------|-----|-----|
| Windows | [TokenFence-Studio-Windows-v1.5.1-portable.zip](https://github.com/Chrisbetheking/tokenfence-studio/releases/latest/download/TokenFence-Studio-Windows-v1.5.1-portable.zip) | 便携版 |
