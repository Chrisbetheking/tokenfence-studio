...
| 平台 | 文件 | 类型 |
|------|-----|-----|
| Windows | [TokenFence-Studio-Windows-v1.4.3-portable.zip](https://github.com/Chrisbetheking/tokenfence-studio/releases/latest/download/TokenFence-Studio-Windows-v1.4.3-portable.zip) | 便携版 |
...
**Chris** — chrisjob@163.com | 微信: easymoneysniperchris
