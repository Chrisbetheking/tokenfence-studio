...
This update introduced the first version of the TokenFence pre-flight prompt safety workflow.

The goal was to make TokenFence Studio more than a regular chat interface. Before a prompt is sent to an LLM, the system performs local checks, detects sensitive information, applies policy-based processing, and shows a safer final prompt preview.
...
The scanner supports several common sensitive data patterns, including:
