...
const en = {
  ...
  runtime: {
    ...
    tauriNotConnected: "Browser mode 閳ユ攺o filesystem access",
  },
  ...
  computerUse: {
    ...
    executionLog: "Execution Log",
    status: "Status",
    allowedTasks: "Allowed Safe Tasks",
    ...
    noMouse: "No mouse control",
    noKeyboard: "No keyboard control",
  ...
  chat: {
    ...
    projectFilesInContext: 'project files in context',
    noProjectLoaded: 'No project loaded',
    enterPath: 'Enter project path...',
    selectFiles: 'Select files',
    selected: 'selected',

    installedModels: 'Installed',
    noInstalledModelsHint: 'No models installed. Add models in Model Library first.',
  project: {
    recentProjects: 'Recent Projects',
    noRecentProjects: 'No recent projects',
    addProject: 'Add Project',
    addProjectHint: 'Click + to add a project folder',
    ...
    justNow: 'Just now',
    emptyRecentTitle: 'No Recent Projects',
    emptyRecentDescription: 'Open a project folder to get started. Recent projects will appear here for quick access.',
  ...
  common: {
    ...
    toolGroupDesc: 'Tools and utilities 锟?status labels show readiness.',
    security: 'Security',
    documents: 'Documents',
    knowledge: 'Knowledge',
    agent: 'Agent',
...
settings: {
  ...
  guardPage: {
    title: "Prompt Shield",
    subtitle: "Prompt safety guard and sensitive information detection",
    status: "Guard Status",
    statusDesc: "Active enforcement of prompt safety rules",
    active: "Active",
    redactionEngine: "Redaction Engine",
    redactionDesc: "Automatically detects and redacts sensitive information before processing",
    policyEngine: "Policy Engine",
    policyDesc: "Enforces configurable safety and privacy policies on all prompts",
    riskAssessment: "Risk Assessment",
    riskDesc: "Evaluates prompt risk level and applies corresponding safety measures",
    safeRouting: "Safe Routing",
    safeRoutingDesc: "Routes prompts through appropriate safety filters based on content type",
    sensitiveDetected: "Sensitive data detected",
    potentialSensitive: "Potential sensitive information detected",
    idNumber: "ID number",
  ...
  modelsPage: {
    ...
    browseLibrary: 'Browse the model library and add models to your installed list.',
  ...
  diagnostics: {
    ...
    shortcutHealth: "Shortcut Health",
    localStorage: "localStorage Health",
    readmeEncoding: "README Encoding",
    modelRunState: "Model Run State",
    sensitiveRedactState: "Sensitive Redaction State",
    projectState: "Project State",
    refreshDiagnostics: "Refresh diagnostics",
    clearProjectState: "Clear project state",
    ok: "OK",
    missing: "Missing",
    invalidJson: "Invalid JSON",
    healthy: "Healthy",
    notChecked: "Not checked",
    releaseChecklist: "Pre-release Checklist",
    checklistCurrentPath: "Current running path is latest version",
    checklistDesktopShortcut: "Desktop shortcut points to latest version",
    checklistStartMenu: "Start Menu shortcut points to latest version",
    checklistReadme: "README files have no encoding issues",
    checklistEmail: "Developer email is correct",
    checklistModelRuntime: "Model runtime is stable",
    checklistSensitive: "Sensitive redaction send flow works",
    shortcutOldVersion: "Shortcut points to old version",
    oldVersionWarning: "If the desktop or taskbar still opens an old version, close all TokenFence processes first, then update the desktop and Start Menu shortcuts.",
    taskbarPinWarning: "If the pinned taskbar shortcut still points to an old version, unpin it manually and re-pin the currently running window.",
    projectStateCleared: "Project state cleared",
  },
  ...
  project: {
    ...
    noProjectFiles: "No project files found. Open a project folder to view files.",
  },
  context: {
    title: "Context Pack",
    empty: "Context Pack is empty.",
    emptyHint: "Select files from the project file tree to add them to context.",
    clear: "Clear",
    remove: "Remove",
