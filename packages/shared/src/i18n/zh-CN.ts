...
const zhCN: Translations = {
  ...
  chat: {
    ...
    noConfiguredModel: "δ����ģ��",
    configureProvider: "����ģ���ṩ��",
    setupProviderHint: "��������һ��ģ���ṩ�̣�Ȼ��ʼ���졣",
    modelConfigured: "\u5DF2\u914D\u7F6E",
  ...
  modelsPage: {
    ...
    goToLibrary: '前往模型库添加模�?,
    installedModels: '已添加模�?,
    modelLibrary: '模型�?,
    addModel: '添加',
    editAlias: '编辑别名',
    setDefault: '设为默认',
    ...
    installedCount: '已安�?{count} �?,
    enabledCount: '已启�?{count} �?,
    lastUsed: '上次使用',
    modelId: '模型 ID',
  },
